  ...
  return {
    ...
    endpoints: {
      ...
      createSuite: {
        ...
        auth: "monitor auth plus the mission-spawn role gate when configured",
        contentType: "application/json",
        note: "operator-created suites are saved immediately and can be run from the Suites panel",
      },
      runSuite: {
        method: "POST",
        path: "/monitor/suites/{id}/run",
        auth: "monitor auth plus the mission-spawn role gate when configured",
      },
      requestSuite: {
        method: "POST",
        path: "/monitor/suites/request",
        auth: "same monitor auth as /monitor",
        contentType: "application/json",
      ...
      approveRequestedSuite: {
        method: "POST",
        path: "/monitor/suites/{id}/approve",
        auth: "monitor auth plus the mission-spawn role gate when configured",
